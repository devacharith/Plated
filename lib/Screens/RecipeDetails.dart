...
import 'package:flutter_recipee_app/model/RecipeMode.dart';
                      ...
                      Expanded(
                        child: TabBarView(
                          children: [
                            ...
                            // Preparation(preparationModel: preparationModel),
                            // Container(
...
class Preparation extends StatelessWidget {
  const Preparation({
    Key key,
    @required this.preparationModel,
  }) : super(key: key);

  final RecipeModel preparationModel;
        ...
        child: Column(
          children: [
            ListView.separated(
              shrinkWrap: true,
              physics: ScrollPhysics(),
              itemCount: preparationModel.ingredients.length,
              itemBuilder: (BuildContext context, int index) {
                return Padding(
                  padding: const EdgeInsets.symmetric(
                    vertical: 2.0,
                  ),
                  child: Text('⚫️ ' + preparationModel.ingredients[index]),
                );
              },
              separatorBuilder: (BuildContext context, int index) {
                return Divider(color: Colors.black.withOpacity(0.3));
